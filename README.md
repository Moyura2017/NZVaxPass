...
```
    ...
    │  3    │     9 │  2960 │      │   │            │ 2952 │       │ 3rd part playload 2960(Dev)/2992(Pro)bits
    ├───────┼───────┼───────┼──────┼───┼────────────┼──────┼───────┼──────────────────────────────────────────
    ...
    │  4.1  │    24 │    32 │   a2 │ 5 │ 101 0 0010 │    2 │   Map │ Map(2): {"kid" ,"alg"}
    │  4.2  │    32 │    40 │   04 │ 0 │ 000 0 0100 │    4 │  +Num │  {4, x} replace 4 with kid {kid,x}
    │  4.3  │    40 │    48 │   45 │ 2 │ 010 0 0101 │    5 │  bStr │  bStr(5*8)
    │  4.4  │    48 │    88 │6b65..│   │            │      │       │  {kid: 'key-1'}
    │  4.5  │    88 │    96 │   01 │ 0 │ 000 0 0001 │    1 │       │  {1, x}  replace 1 with alg {alg,x}
    │  4.6  │    96 │   104 │   26 │ 1 │ 001 0 0110 │    6 │  -num │  {alg: -7(ES256)}  6=>-7 (0=>-1)
    ...
    │  7.9  │   456 │   464 │   04 │ 0 │ 000 0 0100 │    4 │  +Num │   {Key:2}, 4
    │  7.10 │   464 │   472 │   1a │ 0 │ 000 1 1010 │   26 │       │     next 4 bytes
    │  7.11 │   472 │   504 │745040│   │            │  8x4 │       │     {Val:1}, 1951416330 (exp)
    │  7.12 │   504 │   512 │   62 │ 3 │ 011 0 0010 │   62 │  Text │   String(2)
    │  7.13 │   512 │   528 │ 7663 │   │            │    2 │       │   {Key:3}, "vc"
    │  7.14 │   528 │   536 │   a4 │ 5 │ 101 0 0100 │    4 │   Map │  Map(4)
    │  7.15 │   536 │   544 │   68 │ 8 │ 011 0 1000 │    8 │  Text │
    │  7.16 │       │       │      │   │            │      │       │
    │  7.17 │       │       │      │   │            │      │       │
    │  7.18 │       │       │      │   │            │      │       │
    │  7.19 │       │       │      │   │            │      │       │
