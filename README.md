...
>Base-32 encoding tutorial, [by Mobilefish.com](https://youtu.be/Va8FLD-iuTg)
          ...
          INPUT  C       a       t      =>  INQXI===
      1   ASCII  67      97      116                       Decimal (10 base)
      2  Binary  010000110110000101110010                  8bit x3 = 24bits
      3 8bit Gp  [   1  ][   2  ][   3  ][   4  ][   5  ]  Convert to a group of 5bytes (5 x8bit) = 40bits
      ...
      7  To Dec  [ 8 ][13 ][16 ][23 ][ 8 ][ = ][ = ][ = ]  Convert Bin to Dec, replace empty bits with =
